#!/usr/bin/env python3
"""Citation Quality Audit - teaching-oriented citation analysis for ScholarFlow Manuscript Studio.
...
from _manuscript_studio_utils import split_table_line, table_rows
...
USER_AGENT = "ScholarFlow Manuscript Studio/3.0 (citation-quality; https://github.com/WUBING2023/ScholarFlow Manuscript Studio)"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Citation quality audit for ScholarFlow Manuscript Studio.")
...
def audit_citations(output_dir: Path, no_api: bool, timeout: int, delay: float, max_dois: int = 30) -> CitationQualityReport:
    config_path = output_dir / "scholarflow_manuscript_config.json"
    config = {}
