#!/usr/bin/env python3
"""Index local ScholarFlow Manuscript Studio reference materials into source_index.md."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Index local reference materials for ScholarFlow Manuscript Studio.")
    parser.add_argument(
        "paths",
        nargs="*",
        default=["."],
