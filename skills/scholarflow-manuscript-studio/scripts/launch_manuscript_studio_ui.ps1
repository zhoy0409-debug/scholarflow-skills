...
if (-not (Test-Path -LiteralPath $wizard)) {
    throw "ScholarFlow Manuscript Studio intake wizard not found: $wizard"
}
...
Write-Host ''
Write-Host 'ScholarFlow Manuscript Studio intake finished. Config files are in: $escapedOutput'
