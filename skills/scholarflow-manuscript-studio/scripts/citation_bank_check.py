#!/usr/bin/env python3
"""Validate ScholarFlow Manuscript Studio citation_support_bank.md."""
...
from _manuscript_studio_utils import is_separator_row, split_table_line, table_rows, year_from_row
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate ScholarFlow Manuscript Studio citation support bank.")
