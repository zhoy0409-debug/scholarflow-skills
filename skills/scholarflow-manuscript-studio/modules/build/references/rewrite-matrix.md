...
Create `paper_rewriting_output/logic_transfer_audit.md` using the suite guide at `../../../references/logic-transfer-audit.md`. A rewrite is not done until the audit can state how each major section's reasoning changed.
