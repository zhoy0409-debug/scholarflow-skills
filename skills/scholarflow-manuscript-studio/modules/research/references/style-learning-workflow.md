...
4. Record a compact `style_profile.md` before writing qualitative conclusions.
   Include the observed section order, paragraph rhythm, sentence length range,
   citation placement, figure-callout conventions, terminology, and notable
   rhetorical moves. This profile is a descriptive aid, not a reason to copy
   protected prose or unsupported claims.
...
- no `style_profile.md` was produced when analyzable text was available,
