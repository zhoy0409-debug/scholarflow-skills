# ScholarFlow Manuscript Studio Intake

Use this skill before substantive ScholarFlow Manuscript Studio work when the workflow is not yet
configured.
...
When a real terminal is available, route through `manuscript-studio-ui` and use the
...
Use `/manuscript-studio` for normal work; it launches this intake UI automatically
...
On first setup, or when the user asks to change ScholarFlow Manuscript Studio interface language,
