...
Use this reference when ScholarFlow Manuscript Studio needs workflow configuration.
...
The supported ScholarFlow Manuscript Studio UI is the bundled terminal wizard. In Claude Code, use
the `/manuscript-studio` command when installed, or launch the PowerShell wrapper so
