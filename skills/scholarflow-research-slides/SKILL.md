---
name: scholarflow-research-slides
description: Use when a researcher needs one self-contained presentation slide designed, drafted, or revised as editable HTML with a documented visual specification.
---
...
- A relative image source for a file that is not packaged - the iframe preview
  breaks.
