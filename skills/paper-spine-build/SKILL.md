...
description: >-
  ...
  Use `paper-spine` to select this component after intake and evidence planning.
---
...
- Before routing through `paper-spine-latex`, route through `paper-spine-audit` for integrity and structured review. Only proceed when all required dimensions pass.
