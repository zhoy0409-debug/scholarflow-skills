...
This reference supports the `scholarflow-literature-search` skill. Load it only when the current task needs the additional detail implied by the file name.
