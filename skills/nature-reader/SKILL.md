---
name: nature-reader
description: Read research papers deeply and produce structured notes that preserve article logic, figures, methods, evidence chains, limitations, and reusable citation points.
---

# Bilingual Deep Reading — Router
...
- **`source_format`** — `pdf-text` / `scanned-pdf` / `html` / `doi-arxiv` / `pasted-text` · default `pdf-text`
