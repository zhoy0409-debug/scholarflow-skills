...
description: >-
  ...
  Use `paper-spine` to select this component after intake, evidence planning, and citation support.
---
...
Route the completed package through `paper-spine-audit` for integrity and structured review before final delivery.
