---
name: scholarflow-delivery-qa
description: Use when a researcher needs external files staged safely, fragile paths normalized, local toolchain readiness checked, or deliverables rendered and verified before handoff.
---
