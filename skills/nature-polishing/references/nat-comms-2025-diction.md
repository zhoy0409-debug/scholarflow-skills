# Nat Comms 2025 Diction

This reference supports the `nature-polishing` skill. Load it only when the current task needs the additional detail implied by the file name.
