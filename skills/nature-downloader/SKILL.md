...
description: Assist with authorized literature and research-file retrieval workflows while respecting access rights, copyright, institutional permissions, and user-provided sources.
---

# Literature Retrieval — Router
