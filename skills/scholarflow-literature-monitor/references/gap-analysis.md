...
This reference supports the `scholarflow-literature-monitor` skill. Load it only when the current task needs the additional detail implied by the file name.
