# Cn Patent Drafting Guide

This reference supports the `nature-paper-to-patent` skill. Load it only when the current task needs the additional detail implied by the file name.
