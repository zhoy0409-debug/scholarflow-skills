...
| 引用、投稿规范与研究诚信 | 投稿前检查引用真实性、期刊格式要求、过度声称、结果一致性和审稿风险 | `journal-submission-normalizer`, `reference-checker`, `nature-citation`, `research-integrity-guardrail`, `paper-self-review` |
...
Zhoy 的工作流里也有一些内容生产、商业判断和个人决策类 skills。它们可以有用，但不属于这个仓库的科研核心叙事。

这个 GitHub 仓库会优先围绕科研、学术写作、文献、图表、生信分析和交付物整理来组织。其他方向更适合以后单独发布。
